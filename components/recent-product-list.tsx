...
import { RecentsType } from "@/app/(tabs)/profile/recent/page";
import { getMoreRecentProducts } from "@/app/(tabs)/profile/recent/actions";

interface ProductListProps {
  initialProducts: RecentsType;
}
    ...
    const observer = new IntersectionObserver(
      async (
        ...
        if (element.isIntersecting && trigger.current) {
          ...
          // 데이터 불러오기
          setIsLoading(true);
          const newProducts = await getMoreRecentProducts(page + 1);
