...
INSERT INTO "new_Review" ("buyerId", "created_at", "id", "payload", "productId", "rating", "sellerId", "updated_at") SELECT "buyerId", "created_at", "id", "payload", "productId", "rating", "sellerId", "updated_at" FROM "Review";
DROP TABLE "Review";
