/*
  ...
  - Added the required column `receivertId` to the `Review` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Review" (
    ...
    "receivertId" INTEGER NOT NULL,
    "senderId" INTEGER NOT NULL,
    "productId" INTEGER NOT NULL,
    CONSTRAINT "Review_receivertId_fkey" FOREIGN KEY ("receivertId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
