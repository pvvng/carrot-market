...
CREATE TABLE "Heart" (
    ...
    CONSTRAINT "Heart_pkey" PRIMARY KEY ("userId","productId")
);
...
CREATE TABLE "Recent" (
    ...
    CONSTRAINT "Recent_pkey" PRIMARY KEY ("userId","productId")
);
...
-- AddForeignKey
ALTER TABLE "Recent" ADD CONSTRAINT "Recent_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
